...
data_id = "multimodelfolder"

exp_dir = "/scratch2/jzhang-data/cuda102/multinmt-jzhang/opus-100-corpus/v1.0/multimodelfolder/run"
cache_dir = "/scratch2/jzhang-data/cuda102/multinmt-jzhang/opus-100-corpus/v1.0/"
